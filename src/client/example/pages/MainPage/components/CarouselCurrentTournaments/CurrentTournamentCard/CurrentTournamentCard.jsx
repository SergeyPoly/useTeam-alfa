...
// const CurrentTournamentCard = TournamentsData
// .filter(el => el.status === 'current')
// .map(elem => {

//   const currency =  elem.prise_pool==='Energy'?
//   <ThunderboltOutlined style={{ marginTop: '5px', color: '#8B79FF', fontSize: '20px' }}/>:
...
//               <h2 style={CurrentTournamentCardName}>{elem.mode} {elem.name}</h2>
//               <div style={CurrentTournamentCardNamePrize}>
//                 <span>Prize pool</span>
//                 <div style={flexRowStyle}>
//                   {currency}
//                   <h4 style={CurrentTournamentCardSum}>{elem.prise_sum}</h4></div>
//               </div>
//             </div >
...
//                 <div style={CurrentTournamentCardSum}>{currency}<h5 style={CurrentTournamentCardSum}>{elem.entry_from}</h5></div>
//               </div>
//             </div>
//           </div>
//         </div>
