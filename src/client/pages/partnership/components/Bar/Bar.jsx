    ...
    return (
        <div className={styles.bar}>
            <div className={styles.partner}>
                ...
                <Img className={`${titleCheckStatus(status)} ${styles.img__main_partner}`}  src={src} alt={`image`} />
            </div>
            <div className={styles.partner}>
                <p className={styles.text}>Partner (250x120px)</p>
                <Img className={`${subCheckStatus(status)} ${styles.img__sub_partner}`} src={srcSmall} alt={`image`} />
            </div>
